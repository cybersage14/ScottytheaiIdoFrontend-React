import { Box, Button, Container, Link, Stack, useMediaQuery, useTheme } from "@mui/material";
...
export default function Header() {
  ...
  return (
    <Box component="header" position="relative">
      ...
      <Box sx={{ background: 'rgba(0, 0, 0, 0.7)' }} pt={{ xs: 16, md: 36 }} pb={4} position="relative" zIndex={10}>
