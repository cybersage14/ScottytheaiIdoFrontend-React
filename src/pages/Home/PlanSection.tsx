...
export default function PlanSection() {
  ...
  return (
    <Box component="section" bgcolor={grey[900]} py={12}>
      <Container id="plans">
        <SectionTitle variant="h2" textAlign="center">Scotty AI's Plan</SectionTitle>

        <Grid container sx={{ mt: 4 }}>
          <Grid item md={4} sx={{ py: 6, px: 4 }}>
          ...
          <Grid item md={4} sx={{ bgcolor: theme.palette.primary.main, py: 6, px: 4 }}>
